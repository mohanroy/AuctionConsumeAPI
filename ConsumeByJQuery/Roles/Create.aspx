<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="ConsumeByJQuery.Roles.Create" %>
...
<body onload="fnPopulateDropdowns(0);">
    <form id="CreateRole" runat="server">
                    ...
                    <div class="clearfix">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="txtRoleID">RoleID</label>
                                <div class="col-md-10">
                                    <input type="text" id="txtRoleID" name="txtRoleID" placeholder="RoleID" class="form-control" runat="server" />
    ...
    <script src="../Scripts/operation_role.js"></script>
