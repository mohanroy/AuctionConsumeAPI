<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="ConsumeByJQuery.ProductCategories.Create" %>
...
<body onload="fnPopulateDropdowns(0);">
    <form id="CreateProductCategory" runat="server">
                ...
                <div class="col-md-12">
                    <div class="clearfix">
                        <fieldset>
                            ...
                            <legend>&nbsp;&nbsp;Create ProductCategory</legend>
