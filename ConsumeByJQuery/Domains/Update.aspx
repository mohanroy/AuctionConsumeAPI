<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="ConsumeByJQuery.Domains.Update" %>
...
<body onload="fnPopulateDropdowns(1);">
    <form id="UpdateDomain" runat="server">
