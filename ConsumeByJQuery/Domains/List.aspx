<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ConsumeByJQuery.Domains.List" %>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr runat="server" id="trControlHead">
                                            <th style="width: 70%;">DomainID</th>
                                            <th style="width: 15%;">State</th>
                                            <th style="">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody id="domaindetails">
                                    </tbody>
                                </table>
                            </div>
