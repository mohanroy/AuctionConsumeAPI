<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="ConsumeByJQuery.States.Create" %>
...
<body>
    <form id="CreateState" runat="server">
                    ...
                    <div class="clearfix">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <br />
                                    <input type="button" value="Create" onclick="fnADD();" class="btn btn-default" />
